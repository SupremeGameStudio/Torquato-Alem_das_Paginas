...
namespace Scripting.Torquato.Control {
    public class PathLine {
        ...
        public readonly bool autoRunner;
        ...
        public PathLine(PathType type, bool autoRunner, Vector3 pointA, Vector3 pointB) {
            this.type = type;
        ...
        public PathLine(PathPoint pointA, PathPoint pointB) : this(pointA.type, pointA.autoRunner, pointA.transform.position, pointB.transform.position) {
